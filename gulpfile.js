...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new flowcontrol name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/flowcontrol.png')) {
        fs.renameSync(__dirname + '/admin/flowcontrol.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/flowcontrol.html')) {
        fs.renameSync(__dirname + '/widgets/flowcontrol.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/flowcontrol/js/flowcontrol.js')) {
        fs.renameSync(__dirname + '/widgets/flowcontrol/js/flowcontrol.js', __dirname + '/widgets/flowcontrol/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/flowcontrol')) {
        fs.renameSync(__dirname + '/widgets/flowcontrol',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /flowcontrol/g,
        ...
        {
            match: /flowcontrol/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'flowcontrol'
        },
        {
